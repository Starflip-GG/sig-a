                ...
                <div class="left-title">
                    ...
                    <div v-if="blackjackTable.game.type === 'standard'" class="title-standard">
                        ...
                        <div class="title-limits">
                            ...
                            <div class="limits-value">
                                <span>0</span>.10 <span>- 50,000</span>.00
                            </div>
                            )
                        </div>
                    </div>
                    <div v-else class="title-whale">
                        ...
                        <div class="title-limits">
                            ...
                            <img src="@/assets/img/icons/coin.svg" alt="icon" />
                            <div class="limits-value">
                                <span>1,000</span>.00 <span>- 100,000</span>.00
                            </div>
                            )
                        </div>
                    </div>
...
<script>
    ...
    export default {
        name: 'Blackjack',
        metaInfo: {
            title: 'Blackjack - STARFLIP,GG',
            meta: [{ name: 'description', content: 'STARFLIP,GG the leading roblox gambling experience.' }]
        },
        components: {
            IconInfo,
            Bets,
