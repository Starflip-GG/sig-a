    ...
    <nav id="navbar">
        ...
        <div class="navbar-mobile" v-bind:class="{ 'mobile-open': generalSidebarMobile === 'Navbar' }">
            ...
            <div v-if="authUser.user !== null" class="mobile-user">
                <router-link v-on:click.native="generalSetSidebarMobile(null)" to="/profile/settings">
                    <IconUser />
                    Profile
                </router-link>
...
<style scoped>
    ...
    nav#navbar a.link-rewards span {
        ...
        font-size: 14px;
        font-weight: 900;
        background: linear-gradient(180deg, #ffffff 1.75%, rgba(108, 142, 255, 0.85) 35%, rgba(0, 255, 71, 0.55) 70.93%, #7bff90 95%);
    ...
    nav#navbar .navbar-mobile a.link-blackjack.router-link-active {
        background: linear-gradient(250deg, rgb(0, 119, 255) 0%, rgb(0, 150, 170) 100%), #a6cae8;
        -webkit-background-clip: text;
        -webkit-text-fill-color: transparent;
        background-clip: text;
