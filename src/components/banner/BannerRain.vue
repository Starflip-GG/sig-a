...
<style scoped>
    .banner-rain {
        ...
        background: linear-gradient(100deg, rgba(2, 219, 243, 0.74) 0%, rgba(2, 202, 216, 0.65) 7%, rgba(0, 0, 0, 0) 50%),
                    linear-gradient(0deg, rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)),
                    radial-gradient(110% 110% at 50% 30%,rgb(0, 25, 94) 0%, #021729 100%);
        overflow: hidden;
        z-index: 1;
    }
    ...
    .banner-rain .text-header button.button-tip::before {
        ...
        top: 0;
        left: 0;
        background: linear-gradient(180deg, rgba(0, 0, 0, 0) 0%,rgb(1, 139, 225) 100%);
    ...
    .banner-rain .bottom-timer {
        ...
        border: 0.5px solid rgb(52, 107, 180);
    }
