<template>
    <div class="modal-robux">
        ...
        <div class="robux-title">
            <span class="gradient-green">{{modalsData.typeCashier}} RBX</span>
        </div>
        <div class="robux-amount">
            <input v-model="modalAmount" v-on:input="modalValidateInput()" type="text" placeholder="AMOUNT OF RBX" />
        ...
        <div class="robux-info">
            <div v-if="modalsData.typeCashier === 'deposit'" class="info-deposit">
                Enter your desired RBX amount that you want to deposit. Make sure the amount doesn’t exceed your RBX balance of your STARFLIP.GG Account.
            </div>
            <div v-else class="info-withdraw">
                STARFLIP.GG imposes a 30% fee on every transaction, therefore you will receive
...
<style scoped>
    ...
    .modal-robux button.button-action .button-inner {
        ...
        align-items: center;
        padding: 0 32px;
        background: linear-gradient(250deg, rgb(0, 119, 255) 0%, rgb(0, 150, 170) 100%);
