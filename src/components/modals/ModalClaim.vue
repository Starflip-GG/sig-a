<template>
    <div class="modal-claim">
        <div class="claim-header">
            ...
            <span class="gradient-green">CLAIM FREE RBX</span>
        </div>
        <div class="claim-info">Claim free RBX by inviting users, playing on our games or by being active in our discord!</div>
        <div class="claim-input input-affiliate">
            <div class="input-title">Affiliate Code</div>
            <div class="input-info">
                Don't have an affiliate code? Use code "<span>star</span>" for free
