            ...
            <div class="inner-players">
                ...
                <div v-for="(bet, index) in battlesGetBets" v-bind:key="index" class="players-element">
                    <div class="element-user" v-bind:class="[
                        ...
                        <AvatarImage v-if="bet !== null" v-bind:image="bet.bot === true ? bet.user.avatar : bet.user.avatar" />
                        <IconSpinner v-else />
                    </div>
...
<style scoped>
    ...
    .battles-game-element .element-separator::before {
        ...
        top: 0;
        left: 0;
        background: linear-gradient(180deg, rgba(6, 36, 61, 0) 0%, rgb(0, 119, 255) 100%);
    ...
    .battles-game-element button.button-join:before {
        ...
        top: 0;
        left: 0;
        background: linear-gradient(180deg, rgba(0, 170, 109, 0) 0%, rgb(0, 119, 255) 100%);
    ...
    .battles-game-element .funding-inner span {
        font-size: 11px;
        font-weight: 800;
        background: linear-gradient(239deg, rgb(0, 119, 255) -100%, rgb(0, 150, 170) 120%);
        background-clip: text;
        -webkit-background-clip: text;
        -webkit-text-fill-color: transparent;
    }
