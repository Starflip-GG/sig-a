<template>
    ...
    <div class="login-credentials">
        ...
        <div class="credentials-info">
            By accessing STARFLIP.GG, I attest that I am at least 18 years old and have read and agree with the <button v-on:click="loginTermsButton()" class="button-terms">Terms of Service</button>.
        </div>
...
<style scoped>
    ...
    .login-credentials button.button-toggle.button-active::before {
        background: linear-gradient(180deg, rgba(0, 0, 0, 0) 0%,rgb(1, 131, 224) 100%);
    }
    ...
    .login-credentials button.button-action .button-inner {
        color: #ffffff;
        background: linear-gradient(250deg,rgb(0, 136, 255) 0%,rgb(0, 108, 170) 100%);
    }
