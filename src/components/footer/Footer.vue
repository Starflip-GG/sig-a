    ...
    <footer id="footer">
        <div class="footer-top">
            <div class="top-info">
                ...
                <div class="info-text">
                    starflip is the #1 Roblox Gambling Website and offers the best experience & reward to our users.
                    <span class="gradient-green">Innovative Roblox Gambling</span>
                </div>
            </div>
            <div class="top-links">
                ...
                <div class="links-section">
                    ...
                    <a href="https://discord.gg/starflip" target="_blank">Support</a>
        ...
        <div class="footer-bottom">
            <span class="gradient-green">starflip is not affiliated, associated or partnered with the Roblox corporation in any way. We are not authorized, endorsed or sponsored by the Roblox Corporation. All Roblox trademarks remain property of the Roblox Corporation.</span>
        </div>
    </footer>
</template>
