        ...
        methods: {
            ...
            crashSetInput(value, action) {
                ...
                if(action === '2x') {
                    ...
                    amount = this.authUser.user.balance <= 100000000 ? this.authUser.user.balance : 100000000;
                }
...
<style scoped>
    ...
    .crash-controls .controls-mode button.button-active::before {
        background: linear-gradient(180deg, rgba(0, 0, 0, 0) 0%,rgb(1, 202, 224) 100%);
    }
    ...
    .crash-controls .controls-mode button.button-active .button-inner span  {
        background: linear-gradient(255deg,rgb(0, 251, 255) 0%,rgb(0, 99, 170) 100%);
    ...
    .crash-controls .cashout-buttons button .button-inner {
        ...
        font-weight: 800;
        color: #ffffff;
        background: linear-gradient(255deg,rgb(0, 166, 255) 0%,rgb(0, 133, 170) 100%);
    ...
    .crash-controls .controls-manual button.button-bet .button-inner {
        background: linear-gradient(255deg,rgb(0, 195, 255) 0%,rgb(0, 91, 170) 100%);
    }
    ...
    .crash-controls .header-player span {
        margin-left: 5px;
        background: linear-gradient(255deg,rgb(0, 234, 255) 0%,rgb(0, 145, 170) 100%), #ffffff;
        -webkit-background-clip: text;
        -webkit-text-fill-color: transparent;
        background-clip: text;
        text-fill-color: transparent;
    ...
    .crash-controls .controls-auto button.button-stop .button-inner {
        ...
        font-weight: 800;
        color: #ffffff;
        background: linear-gradient(255deg,rgb(0, 242, 255) 0%,rgb(0, 99, 170) 100%);
        clip-path: polygon(7px 0, calc(100% - 7px) 0, 100% 25%, 100% 75%, calc(100% - 7px) 100%, 7px 100%, 0 75%, 0 25%);
    }
