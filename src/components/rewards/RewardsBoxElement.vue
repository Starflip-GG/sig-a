<template>
    <router-link class="rewards-box-element" v-bind:class="['element-' + rewardsGetState]" to="/unbox/6786d3c5c8a5da4971f39eea">
        <div class="element-state">{{ rewardsGetState }}</div>
        <div class="element-name">
            <div class="name-inner">Level 5 Case</div>
        </div>
        <div class="element-image">
            <img src="https://i.imgur.com/OPdH0L6.png" />
        </div>
...
<style scoped>
    ...
    .rewards-box-element .element-state {
        ...
        font-weight: 700;
        color: #ffffff;
        background: linear-gradient(256deg,rgb(0, 204, 255) 0%,rgb(0, 142, 170) 100%);
