<template>
    <div class="rewards-code">
        <div class="code-inner">
            ...
            <div class="inner-info">Start your journey on STARFLIP with a little bonus! Redeem a code to earn free 10 RBX.</div>
            <div class="inner-input">
                ...
                <div class="input-info">
                    Don't have a code? Use code <span>star</span>
                </div>
            </div>
        </div>
    </div>
