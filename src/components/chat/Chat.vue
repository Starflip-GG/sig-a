...
<style scoped>
    ...
    aside#chat .chat-toggle button .button-inner {
        ...
        align-items: center;
        background: linear-gradient(255deg, #003aff 0%, #0034aa 75%);
   ...
   aside#chat .content-messages {
    ...
    aside#chat .content-lock button.button-lock::before {
        ...
        top: 0;
        left: 0;
        background: linear-gradient(180deg, rgba(0, 0, 0, 0) 0%, #01c0e1 100%);
    ...
    aside#chat .content-lock button.button-lock .button-inner {
        ...
        font-weight: 700;
        color: #ffffff;
        background: linear-gradient(90deg, rgba(0, 0, 0, 0.128) 0%, rgba(0, 33, 24, 0.132) 25%, rgba(0, 99, 73, 0.144986) 60%, rgba(1, 193, 143, 0.0925409) 80%, rgba(1, 237, 176, 0.068) 100%) #0d2578;
        clip-path: polygon(7px 0, calc(100% - 7px) 0, 100% 25%, 100% 75%, calc(100% - 7px) 100%, 7px 100%, 0 75%, 0 25%);
    }
