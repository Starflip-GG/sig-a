    ...
    <div class="admin-filter-amount" v-bind:class="{ 'amount-open': adminDropdown === true }">
        ...
        <div class="amount-menu">
            <div class="menu-inner">
                <button v-on:click="adminSetButton('1')">$1 GIFT CARD</button>
                <button v-on:click="adminSetButton('2')">$2 GIFT CARD</button>
                <button v-on:click="adminSetButton('3')">$3 GIFT CARD</button>
                <button v-on:click="adminSetButton('4')">$4 GIFT CARD</button>
                <button v-on:click="adminSetButton('5')">$5 GIFT CARD</button>
                <button v-on:click="adminSetButton('6')">$6 GIFT CARD</button>
                <button v-on:click="adminSetButton('7')">$7 GIFT CARD</button>
                <button v-on:click="adminSetButton('8')">$8 GIFT CARD</button>
                <button v-on:click="adminSetButton('9')">$9 GIFT CARD</button>
