...
<style scoped>
    ...
    .cashier-element.element-Gems {
        background: linear-gradient(90deg, #2775ca 0%, rgba(39, 117, 202, 0.3) 100%);
    }
    .cashier-element.element-MM2 {
        background: linear-gradient(90deg, #ca9127 0%, rgba(255, 51, 0, 0.3) 100%);
    }
    ...
    .cashier-element.element-Gems .element-inner {
    background: radial-gradient(650% 160% at 100% 25%, rgba(0, 20, 37, 0.27) 0%, rgba(0, 0, 0, 0) 100%), 
                linear-gradient(0deg, rgba(26, 147, 247, 0.15) 0%, rgba(26, 147, 247, 0.15) 100%), 
                linear-gradient(90deg, rgba(26, 147, 247, 0.62) -30%, rgba(0, 0, 0, 0) 180%), 
                linear-gradient(265deg, #001f3e 0%, rgba(12, 52, 82, 0) 150%),
                repeating-linear-gradient(-55deg, transparent, transparent 5px, rgba(2, 21, 36, 0.12) 5px, rgba(2, 21, 36, 0.12) 10px);
}

.cashier-element.element-MM2 .element-inner {
    background: radial-gradient(650% 160% at 100% 25%, rgba(80, 10, 10, 0.27) 0%, rgba(0, 0, 0, 0) 100%), 
                linear-gradient(0deg, rgba(255, 77, 51, 0.15) 0%, rgba(255, 77, 51, 0.15) 100%), 
                linear-gradient(90deg, rgba(255, 77, 51, 0.62) -30%, rgba(0, 0, 0, 0) 180%), 
                linear-gradient(265deg, #6a1b1a 0%, rgba(12, 52, 82, 0) 150%),
                repeating-linear-gradient(-55deg, transparent, transparent 5px, rgba(2, 21, 36, 0.12) 5px, rgba(2, 21, 36, 0.12) 10px);
}
    ...
    .cashier-element.element-Gems .text-method {
        color: #00d5ff;
    }

    .cashier-element.element-MM2 .text-method {
        color: #ff2a00;
    }
