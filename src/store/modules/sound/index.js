const state = {
    ...
    soundMineHit: new Audio(require('@/assets/sounds/minehit.mp3')),
    soundCoinHit: new Audio(require('@/assets/sounds/coinhit.mp3')),
    soundGameStart: new Audio(require('@/assets/sounds/game_start.mp3')),
    soundBlackjackHit: new Audio(require('@/assets/sounds/blackjackhit.mp3'))
}
...
const getters = {
    ...
    soundMineHit: state => state.soundMineHit,
    soundCoinHit: state => state.soundCoinHit,
    soundGameStart: state => state.soundGameStart,
    soundBlackjackHit: state => state.soundBlackjackHit
}
